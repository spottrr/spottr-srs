...
\textbf{Alternative Flows} &
    \begin{itemize}[nosep, leftmargin=*]
        \item \textit{Incorrect clustering:} The system has grouped two different people into one cluster. The user manually splits the cluster into separate identities.
...
\textbf{Main Success Scenario} &
    \begin{enumerate}[nosep, leftmargin=*]
        ...
        \item The system starts the processing pipeline: frame extraction, SAM segmentation, CLIP encoding, and InsightFace face detection.
